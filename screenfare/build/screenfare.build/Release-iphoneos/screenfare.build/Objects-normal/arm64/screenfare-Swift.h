...
#ifndef SCREENFARE_SWIFT_H
#define SCREENFARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="screenfare",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10screenfare19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(screenfare)) <UNUserNotificationCenterDelegate>
